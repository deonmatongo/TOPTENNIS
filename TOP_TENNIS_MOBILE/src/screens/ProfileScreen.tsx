...
const styles = StyleSheet.create({
  ...
  editBtnText: { fontSize: FontSize.md, color: '#fff', fontWeight: FontWeight.semibold },
  scroll: { flex: 1 },
  ...
  avatarOverlay: { position: 'absolute', bottom: 0, left: 0, right: 0, top: 0, borderRadius: 40, backgroundColor: 'rgba(0,0,0,0.38)', alignItems: 'center', justifyContent: 'center' },
  changePhotoBtn: { paddingHorizontal: Spacing.sm, paddingVertical: 3 },
  ...
  sectionTitle: { fontSize: FontSize.md, fontWeight: FontWeight.semibold, color: Colors.textSecondary, textTransform: 'uppercase', letterSpacing: 0.5, marginTop: Spacing.md },
  infoCard: {},

  formRow: { flexDirection: 'row' },
  formGroup: { marginBottom: Spacing.md },
  formLabel: { fontSize: FontSize.sm, fontWeight: FontWeight.medium, color: Colors.text, marginBottom: Spacing.xs },
  formInput: { borderWidth: 1.5, borderColor: Colors.border, borderRadius: Radius.md, paddingHorizontal: Spacing.md, paddingVertical: Spacing.sm + 2, fontSize: FontSize.md, color: Colors.text, backgroundColor: Colors.background },
  textArea: { height: 80, textAlignVertical: 'top' },

  skillGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: Spacing.sm },
  skillBtn: { width: 44, height: 44, borderRadius: Radius.md, borderWidth: 1.5, borderColor: Colors.border, alignItems: 'center', justifyContent: 'center' },
  ...
  chip: { paddingHorizontal: Spacing.md, paddingVertical: Spacing.xs + 2, borderRadius: Radius.full, borderWidth: 1.5, borderColor: Colors.border },
  ...
  settingsBtn: { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, paddingVertical: Spacing.md, paddingHorizontal: Spacing.lg, marginTop: Spacing.md, borderWidth: 1, borderColor: Colors.border, borderRadius: Radius.md, backgroundColor: Colors.surface },
  settingsBtnText: { fontSize: FontSize.md, color: Colors.textSecondary, fontWeight: FontWeight.medium },

  signOutBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: Spacing.sm, paddingVertical: Spacing.lg, marginTop: Spacing.sm, borderWidth: 1.5, borderColor: Colors.error + '40', borderRadius: Radius.md, backgroundColor: Colors.errorLight },
