      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-2">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black leading-tight mb-6 text-gray-900">
              Common Questions
            </h2>
            ...
            {faqs.map((faq, i) => (
              <div key={i}>
                <button
                  ...
                  className="w-full flex items-start justify-between gap-4 py-5 text-left text-gray-900 hover:text-orange-500 transition-colors"
                >
                  <span className="text-sm sm:text-base font-semibold leading-snug">
                    {faq.question}
                  </span>
                  <ChevronDown
                    className={`w-5 h-5 shrink-0 mt-0.5 text-gray-400 transition-transform duration-200 ${open === i ? "rotate-180 text-orange-500" : ""}`}
                  />
                </button>
                <div
