...
const SECTIONS: { title: string; body: string[] }[] = [
  ...
  },
  {
    title: 'Contact us',
    body: [
      'Questions about these Terms? Email support@toptennis.app and we will be happy to help.',
    ],
  },
];
      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-28 lg:pt-32 pb-8 sm:pb-12 lg:pb-16">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-3 sm:mb-4">Terms of Service</h1>
